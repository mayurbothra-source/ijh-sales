...
function NewItemTab({ idx, items, updateItem, mixParams }) {
  ...
  // Local state for free-text / numeric fields — prevents re-render focus loss
  ...
  // Line total computed from local values so it updates live while typing
  ...
  return (
    <Modal title="Log New Order" onClose={onClose}>
      ...
      <div style={{ marginTop: 12 }}>
        ...
        {/* Active item form */}
        <NewItemTab idx={activeTab} items={items} updateItem={updateItem} mixParams={mixParams} />
      </div>
